<?php
add_action('wp_enqueue_scripts', 'initcyberliteStylesAndScripts');
add_action('after_setup_theme', 'featurescyberlite');
...
function initcyberliteStylesAndScripts() {
    // INCLUDE STYLES
    wp_enqueue_style('fontAwesomeIcons', 'https://use.fontawesome.com/releases/v5.1.0/css/all.css');
    wp_enqueue_style('customStyle', get_template_directory_uri() . '/assets/css/cyberlite.css', array(), '1.0.0', 'all');
    ...
    wp_enqueue_script('customJS', get_template_directory_uri() . '/assets/js/cyberlite.js', array(), true, true);
}
...
function pageBanner($args = NULL) {
  ...
  <div class="page-banner">
    ...
    <div class="page-banner__content">
      <p class="page-banner__title"><?php echo $args['title'] ?></p>
...
function customLoginCSS() {
  wp_enqueue_style('customStyle', get_template_directory_uri() . '/assets/css/cyberlite.css');
